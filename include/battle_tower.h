...
extern const u8 gTowerMaleFacilityClasses[42];
extern const u16 gTowerMaleTrainerGfxIds[42];
extern const u8 gTowerFemaleFacilityClasses[28];
extern const u16 gTowerFemaleTrainerGfxIds[28];
