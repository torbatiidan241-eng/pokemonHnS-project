const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(DEOXYS_ATTACK, gMonFrontPic_DeoxysA),
    SPECIES_SPRITE(DEOXYS_DEFENSE, gMonFrontPic_DeoxysD),
    SPECIES_SPRITE(DEOXYS_SPEED, gMonFrontPic_DeoxysS),
    ...
    SPECIES_SPRITE(URSALUNA_BLOODMOON, gMonFrontPic_Ursaluna_BloodMoon),
