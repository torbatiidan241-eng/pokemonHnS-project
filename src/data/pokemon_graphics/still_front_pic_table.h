...
// Gen III
    ...
    SPECIES_SPRITE(DEOXYS_ATTACK,  gMonStillFrontPic_DeoxysA),
    SPECIES_SPRITE(DEOXYS_DEFENSE,  gMonStillFrontPic_DeoxysD),
    SPECIES_SPRITE(DEOXYS_SPEED,  gMonStillFrontPic_DeoxysS),
    ...
    SPECIES_SPRITE(REGIELEKI,  gMonStillFrontPic_Regieleki),
    ...
    SPECIES_SPRITE(MIME_JR,  gMonStillFrontPic_MimeJr),
    ...
    SPECIES_SPRITE(REGIDRAGO,  gMonStillFrontPic_Regidrago),
    ...
    SPECIES_SPRITE(DUDUNSPARCE, gMonStillFrontPic_Dudunsparce),
    SPECIES_SPRITE(WYRDEER, gMonStillFrontPic_Wyrdeer),
    SPECIES_SPRITE(URSALUNA, gMonStillFrontPic_Ursaluna),
    SPECIES_SPRITE(URSALUNA_BLOODMOON, gMonStillFrontPic_Ursaluna_BloodMoon),
    SPECIES_SPRITE(KLEAVOR, gMonStillFrontPic_Kleavor),
    //SPECIES_SPRITE(UNUSED_SPACE5, gMonStillFrontPic_Unused_Space5),
    //SPECIES_SPRITE(UNUSED_SPACE6, gMonStillFrontPic_Unused_Space6),
    //SPECIES_SPRITE(UNUSED_SPACE7, gMonStillFrontPic_Unused_Space7),
    //SPECIES_SPRITE(UNUSED_SPACE8, gMonStillFrontPic_Unused_Space8),
    //SPECIES_SPRITE(UNUSED_SPACE9, gMonStillFrontPic_Unused_Space9),
    //SPECIES_SPRITE(UNUSED_SPACE10, gMonStillFrontPic_Unused_Space10),
};
