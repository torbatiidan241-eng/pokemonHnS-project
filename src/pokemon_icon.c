...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_DEOXYS_ATTACK] = gMonIcon_DeoxysA,
    [SPECIES_DEOXYS_DEFENSE] = gMonIcon_DeoxysD,
    [SPECIES_DEOXYS_SPEED] = gMonIcon_DeoxysS,
    ...
    //[SPECIES_URSALUNA_BLOODMOON] = gMonIcon_Unused_Space3, 
    //[SPECIES_KLEAVOR] = gMonIcon_Unused_Space4, 
