...
static void SetupRoomObjectEvents(void)
{
    ...
    VarSet(VAR_OBJ_GFX_ID_1, OBJ_EVENT_GFX_MON_BASE+SPECIES_DUSCLOPS);
    setObjGfx1 = TRUE;
    setObjGfx2 = FALSE;
    objGfx1 = 0;
    objGfx2 = 0;
    ...
    case PIKE_ROOM_STATUS:
        ...
        if (sStatusMon == PIKE_STATUSMON_DUSCLOPS)
            objGfx2 = OBJ_EVENT_GFX_MON_BASE+SPECIES_DUSCLOPS;
        else
            objGfx2 = OBJ_EVENT_GFX_MON_BASE+SPECIES_KIRLIA;
        setObjGfx2 = TRUE;
        break;
...
static bool8 DoesTypePreventStatus(u16 species, u32 status)
{
    ...
    case STATUS1_FREEZE:
        ...
        break;
    case STATUS1_PARALYSIS:
        if (GetTypeBySpecies(species, 1) == TYPE_GROUND || GetTypeBySpecies(species, 1) == TYPE_ELECTRIC
            || GetTypeBySpecies(species, 2) == TYPE_GROUND || GetTypeBySpecies(species, 2) == TYPE_ELECTRIC)
            ret = TRUE;
        break;
    case STATUS1_BURN:
