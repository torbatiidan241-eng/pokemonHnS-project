...
const struct TrainerBallBF gTrainerBallTableBF[] = {
    ...
    {FACILITY_CLASS_RUIN_MANIAC, ITEM_HEAVY_BALL},
    ...
    {FACILITY_CLASS_HEX_MANIAC, ITEM_MOON_BALL},
    {FACILITY_CLASS_LADY, ITEM_LUXURY_BALL},
    {FACILITY_CLASS_BEAUTY, ITEM_LOVE_BALL},
    ...
    {FACILITY_CLASS_FIREBREATHER, ITEM_LEVEL_BALL},
    {FACILITY_CLASS_CAMPER, ITEM_NEST_BALL},
    {FACILITY_CLASS_OLD_COUPLE, ITEM_POKE_BALL},
    {FACILITY_CLASS_BUG_MANIAC, ITEM_NET_BALL},
    {FACILITY_CLASS_PSYCHIC_M, ITEM_MOON_BALL},
    {FACILITY_CLASS_PSYCHIC_F, ITEM_MOON_BALL},
    ...
    {FACILITY_CLASS_FISHERMAN, ITEM_LURE_BALL},
    ...
    {FACILITY_CLASS_DRAGON_TAMER, ITEM_LEVEL_BALL},
    {FACILITY_CLASS_BIRD_KEEPER, ITEM_FAST_BALL},
    {FACILITY_CLASS_NINJA_BOY, ITEM_ULTRA_BALL},
    {FACILITY_CLASS_BATTLE_GIRL, ITEM_FAST_BALL},
    ...
    {FACILITY_CLASS_PKMN_BREEDER_F, ITEM_FRIEND_BALL},
    {FACILITY_CLASS_PKMN_BREEDER_M, ITEM_FRIEND_BALL},
    ...
    {FACILITY_CLASS_HIKER, ITEM_HEAVY_BALL},
