...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    [SPECIES_REGIELEKI]  = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_ARCEUS]      = BACK_ANIM_GROW_STUTTER,
    [SPECIES_AMBIPOM]     = BACK_ANIM_H_SPRING_REPEATED,
    [SPECIES_BONSLY]        = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_BUDEW]         = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_CHINGLING]     = BACK_ANIM_DIP_RIGHT_SIDE,
    ...
    [SPECIES_HAPPINY]       = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_HONCHKROW]     = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_LEAFEON]       = BACK_ANIM_SHAKE_GLOW_GREEN,
    [SPECIES_LICKILICKY]    = BACK_ANIM_H_SLIDE,
    [SPECIES_MAGMORTAR]     = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_MAGNEZONE]     = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_MAMOSWINE]     = BACK_ANIM_H_SHAKE,
    [SPECIES_MANTYKE]       = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_MISMAGIUS]     = BACK_ANIM_H_VIBRATE,
    [SPECIES_MIME_JR]       = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_MUNCHLAX]      = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_PORYGON_Z]     = BACK_ANIM_H_VIBRATE,
    [SPECIES_PROBOPASS]     = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_REGIDRAGO]     = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_REGIGIGAS]     = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_RHYPERIOR]     = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_ROSERADE]      = BACK_ANIM_SHAKE_GLOW_GREEN,
    [SPECIES_SYLVEON]       = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_TANGROWTH]     = BACK_ANIM_V_STRETCH,
    [SPECIES_TOGEKISS]      = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_WEAVILE]       = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_YANMEGA]       = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_ANNIHILAPE]    = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_FARIGIRAF]     = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_DUDUNSPARCE]   = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_WYRDEER] = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_URSALUNA] = BACK_ANIM_V_SHAKE,
    [SPECIES_URSALUNA_BLOODMOON] = BACK_ANIM_V_SHAKE,
    [SPECIES_KLEAVOR] = BACK_ANIM_SHRINK_GROW,
    [SPECIES_UNUSED_SPACE5] = BACK_ANIM_SHRINK_GROW,
    [SPECIES_UNUSED_SPACE6] = BACK_ANIM_SHRINK_GROW,
    [SPECIES_UNUSED_SPACE7] = BACK_ANIM_SHRINK_GROW,
    [SPECIES_UNUSED_SPACE8] = BACK_ANIM_SHRINK_GROW,
    [SPECIES_UNUSED_SPACE9] = BACK_ANIM_SHRINK_GROW,
