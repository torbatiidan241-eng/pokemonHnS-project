...
const u8 gText_TreeckoDoll48BP[] = _("TREECKO DOLL{CLEAR_TO 0x5E}48BP");
const u8 gText_TorchicDoll48BP[] = _("TORCHIC DOLL{CLEAR_TO 0x5E}48BP");
const u8 gText_MudkipDoll48BP[] = _("MUDKIP DOLL{CLEAR_TO 0x5E}48BP");
